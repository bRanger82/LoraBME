...
void Setup_BME_Sensor(void)
{
  ...
  unsigned status = bme.begin(BME280_I2C_ADDR);  
  if (status) 
  {
...
void setup()
{
  ...
  Serial.flush();
  delay(50);
  // I2C is initialized with the LoRa library. So this step has to be done before other I2C devices are initialized.
  SetupLoRa(); 
  delay(50);
